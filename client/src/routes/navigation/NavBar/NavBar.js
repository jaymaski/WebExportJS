...
import {faBars, faSearch, faBell, faFileAlt, faFile, faDonate, faExclamationTriangle} from '@fortawesome/free-solid-svg-icons'
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-primary" type="button">
                                    ...
                                    <i><FontAwesomeIcon icon={faSearch} size={16}/></i>
                                </button>
                            </div>
                        </div>
                    </form>
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="mr-3">
                                        <div class="icon-circle bg-success">
                                            <i><FontAwesomeIcon icon={faDonate}/></i>
                                        </div>
                                    </div>
                                    <div>
